...
export function IconYouTube({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
...
export function IconFacebook({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
...
export function IconTikTok({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
...
export function IconTwitter({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
...
export function IconLinkedin({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
...
export function IconGlobe({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
      <circle cx="12" cy="12" r="10" />
...
export function IconInstagram({ size, color, style, className }: IconProps) {
  return (
    <svg width={size || dflt.size} height={size || dflt.size} viewBox="0 0 24 24" fill="none" stroke={color || dflt.color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={style} className={className}>
