-- Create Mic Mtaani Tables Only (No Sample Data)
-- This creates the tables without inserting any data that might violate constraints
...
-- Events table (without constraints that might cause issues)
...
-- Success message
SELECT 'Mic Mtaani tables created successfully! No sample data inserted.' as result;